...
class ZnLatestPostsSlider2 extends ZnElements {
	...
	function element() {
		...
		$navStyle = $this->opt('nav_style','navStyle2 hollowNav');
		...
		?>
			<div class="news-small zn_owl_carousel owl-carousel owl-theme <?php echo $navStyle; ?> <?php echo $style.' '.$this->data['uid']; ?>"  data-auto="<?php echo esc_attr( $autoScroll );?>" data-pagination="<?php echo $show_bullets;?>" data-navigation="<?php echo $show_navigation;?>">
			...
			<div class="item">
				<div class="row">
					...
					<div class="col-sm-6 postCol">
					<div class="news-small-post">
						<span class="caption-date zn-primary-color"><?php the_time("$first/$second"); ?></span>
						<a href="<?php the_permalink(); ?>">
                            <h4>
                                <?php echo zn_trim_to_size(get_the_title() ? get_the_title() : the_ID(), $max_chars); ?>
                            </h4>
                        </a>
						<?php zn_show_hearts( $post, true,'zn-secondary-color', 'zn-paragraph-color' ); ?>
						<span class="zn_comments icon-bubbles4 mleft10">
