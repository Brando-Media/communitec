...
<body <?php body_class(); ?> onload="_googWcmGet('number', '+44 (0) 203-700-8585')">
	...
	<div class="mobile_menu_wrapper">
		...
		<a id="close_mobile_menu"><i class="fa fa-close"></i></a>
		...
		<?php
    	   ...
    	   <img src="http://av.communitec.co/wp-content/uploads/2018/07/communitec-website-logo.png" style="height:auto; width:100%; margin-bottom:-10px; max-width: 260px"/>
		...
		<img src="http://av.communitec.co/wp-content/uploads/2017/03/logos-for-menu.jpg" style="margin-bottom:10px; margin-top:-50px; width:40%;"/>
		...
		class="has-label"><strong>Address</strong><br><div>79 York 

		Street<br /> London<br /> W1H 1QQ<br /> United 
