...
<div class="social_wrapper">
    <ul>
		<?php
        	$pp_houzz_username = get_option('pp_houzz_username');
        	
        	if(!empty($pp_houzz_username)) {
				if (is_front_page()) { ?>
					
					<li class="facebook"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="Houzz" href="<?php echo esc_attr($pp_houzz_username); ?>"><i class="icon-houzz-light"></i></a></li>
			<?php	}
        	
        	else { ?>
			
			<li class="facebook"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="Houzz" href="<?php echo esc_attr($pp_houzz_username); ?>"><i class="icon-houzz-dark"></i></a></li>
		<?php			
