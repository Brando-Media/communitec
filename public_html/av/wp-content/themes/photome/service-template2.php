...
<div id="landing-page-new">
	...
	<div style="text-align: center;float:left;width: 100%;height: 100%;padding-top: 30px;padding-bottom: 30px;border-bottom: 2px solid #222;" id="About-Us">
		...
		<div class="one withsmallpadding ppb_text" style="padding:30px; padding-top: 0;">
			<p style="text-align: center;"><img style="max-width: 100%;" src="http://av.communitec.co/wp-content/uploads/2017/02/Lighting-Brands.jpg" alt="Lutron, Q Motion, Rako, Ocean Air, Smart, Home"></p>
		</div>
	...
	<div class="ppb_wrapper" style="float:left;width: 100%;height: 100%">
		<div class="cs-col cs-col-12 withsmallpadding ppb_text">
			<div class="cs-col cs-col-6">
				<div>
					<a href="http://av.communitec.co/portfolios/lighting-shading/"><img src="http://av.communitec.co/wp-content/uploads/2016/11/HomeCinema.jpg" alt="Home, Cinema, TV, Projector, Speakers, Surround Sound, Lighting"></a>
				</div>
			</div>
			<div class="cs-col cs-col-6">
		...
		<div class="cs-col cs-col-12 withsmallpadding ppb_text">					
			<div class="cs-col cs-col-6 push-right">
				<div>
					<a href="http://av.communitec.co/portfolios/lighting-shading/"><img src="http://av.communitec.co/wp-content/uploads/2017/03/lighting-control.jpg" alt="Smart, Home, Lighting, Control, App, iPhone, Scenes, Saving"></a>
				</div>
			</div>
		...
		<div class="cs-col cs-col-12 withsmallpadding ppb_text">
			<div class="cs-col cs-col-6">
				<div>
					<a href="http://av.communitec.co/portfolios/lighting-shading/"><img src="http://av.communitec.co/wp-content/uploads/2017/03/Lighting01.jpg" alt="Smart, Home, Lighting, Lutron, Rako, Install"></a>
				</div>
			</div>
			<div class="cs-col cs-col-6">
				<div style="padding:20px; max-width: 768px;">
		...
		<div class="cs-col cs-col-12 withsmallpadding ppb_text">					
			<div class="cs-col cs-col-6 push-right">
				<div>
					<a href="http://av.communitec.co/portfolios/lighting-shading/"><img src="http://av.communitec.co/wp-content/uploads/2017/03/blinds.jpg" alt="Lutron, Savant, Ocean Air, Q Motion, Automated, Blinds, Smart, Home"></a>
				</div>
			</div>
			<div class="cs-col cs-col-6 push-left">
				<div style="padding:20px; max-width: 768px;" class="push-right">
