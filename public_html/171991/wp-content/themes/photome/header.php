...
<body <?php body_class(); ?>>
	...
	<div class="mobile_menu_wrapper">
		...
		<?php
    	   ...
    	   <img src="http://communitec.co/171991/wp-content/themes/photome/images/logo.png" style="height:auto; width:100%; margin-bottom:-10px;"/>
    	   
    	   <p><i>Bring technology into design</i></p>
	    ...
	    <?php 
			...
			if ( has_nav_menu( 'side-menu' ) ) 
			{
			    ...
			    ?>
		<img src="http://communitec.co/171991/wp-content/themes/photome/images/logos-for-menu.png" style="margin-bottom:10px; margin-top:-50px; width:40%;"/>
		...
		class="has-label"><strong>Phone</strong><br><div>+44 (0) 203 
		700 8585</div></li><li 
