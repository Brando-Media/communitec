...
?>
	...
	<div id="ppb_page_content" class="hidden">
		...
		<div class="ppb_page_action">
			<a id="ppb_preview_page" class="tooltipster" title="<?php esc_html_e('Preview Page', THEMEDOMAIN ); ?>" data-action="<?php echo esc_url(admin_url('admin-ajax.php?action=photome_ppb_preview_page_set_data')); ?>" data-preview="<?php echo esc_url(admin_url('admin-ajax.php?action=photome_ppb_preview_page&ppb_post_type=page&page_id='.$post->ID)); ?>" data-page="<?php echo esc_attr($post->ID); ?>"><i class="fa fa-search"></i></a>
	...
	<a id="ppb_sortable_preview_button" class="button" style="float:left;" href="<?php echo esc_url(admin_url('admin-ajax.php?action=photome_ppb_demo_preview')); ?>"><i class="fa fa-search"></i><?php esc_html_e('Preview', THEMEDOMAIN ); ?></a>
	<a id="ppb_sortable_add_button" class="button button-primary" style="float:left;"><i class="fa fa-arrow-down"></i><?php esc_html_e('Add', THEMEDOMAIN ); ?></a>
