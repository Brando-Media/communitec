...
?>
<div id="cs1-form2"><?php echo do_shortcode( '[contact-form-7 id="4366" title="Contact form 1"]' ); ?></div>
<br class="clear"/>
...

{
...

   {
       ...
       if(jQuery('.nf-response-msg:contains("Thank you so much for contacting us.")').length > 0)

       {

			(new (Image)).src ="//www.googleadservices.com/pagead/conversion/878640358/?label=Y0h7CKPZomgQ5vn7ogM&guid=ON&script=0";
...
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 878640358;
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/878640358/?guid=ON&amp;script=0"/>
</div>
</noscript>
