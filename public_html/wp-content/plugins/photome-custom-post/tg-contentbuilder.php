...
function ppb_text_sidebar_func($atts, $content) {
	...
	$return_html.= get_dynamic_sidebar(rawurldecode($sidebar));
...
function ppb_header_func($atts, $content) {
	...
	if(!empty($title))
	{
		$return_html.= '<h2 class="ppb_title" style="'.esc_attr($custom_css_fontcolor).'">'.rawurldecode(tg_get_first_title_word($title)).'</h2>';
	}
...
function ppb_image_half_fullwidth_func($atts, $content) {
	...
	if($align=='left')
	{
		...
		if(!empty($title))
		{
			...
			$return_html.= '>'.rawurldecode(tg_get_first_title_word($title)).'</h2>';
		}
		if(!empty($subtitle))
		{
...
function ppb_portfolio_grid_func($atts, $content) {
	...
	if(!empty($portfolios_arr) && is_array($portfolios_arr))
	{
		...
		foreach($portfolios_arr as $key => $portfolio)
		{
            ...
            $terms = wp_get_post_terms($portfolio_ID, 'portfoliosets');
            $cats = array();
            ...
            $the_cat = implode(' ', $cats);
			
			//Begin display HTML
			$return_html.= '<div class="element the_portfolio_item '.$the_cat.' '.esc_attr($grid_wrapper_class).'">';
			...
			if(!empty($image_url[0]))
			{
			    ...
			    case 'External Link':
					...
					$return_html.= '<a target="_blank" href="'.esc_url($portfolio_link_url).'"><img src="'.esc_url($image_url[0]).'" alt="'.esc_attr($portfolio->post_title).'"/><div id="portfolio_desc_'.esc_attr($portfolio_ID).'" class="portfolio_title">
        					<div class="table">
        						<div class="cell">
        	    ...
        	    default:
		        	...
		        	$return_html.= '<a href="'.get_permalink($portfolio_ID).'"><img src="'.esc_url($image_url[0]).'" alt="'.esc_attr($portfolio->post_title).'"/><div id="portfolio_desc_'.esc_attr($portfolio_ID).'" class="portfolio_title">
        					<div class="table">
        						<div class="cell">
						            <h5>'.$portfolio->post_title.'</h5>
						            <div class="post_detail">'.$portfolio->post_excerpt.'</div>
        	    ...
        	    case 'Image':
					...
					$return_html.= '<a data-title="'.esc_attr($portfolio->post_title).'" href="'.esc_url($image_url[0]).'" class="fancy-gallery"><img src="'.esc_url($image_url[0]).'" alt="'.esc_attr($portfolio->post_title).'"/><div id="portfolio_desc_'.esc_attr($portfolio_ID).'" class="portfolio_title">
        					<div class="table">
        						<div class="cell">
						            <h5>'.$portfolio->post_title.'</h5>
						            <div class="post_detail">'.$portfolio->post_excerpt.'</div>
			    ...
			    case 'Youtube Video':
					...
					$return_html.= '<a title="'.esc_attr($portfolio->post_title).'" href="#video_'.$portfolio_video_id.'" class="lightbox_youtube"><img src="'.esc_url($image_url[0]).'" alt="'.esc_attr($portfolio->post_title).'"/><div id="portfolio_desc_'.esc_attr($portfolio_ID).'" class="portfolio_title">
        					<div class="table">
        						<div class="cell">
						            <h5>'.$portfolio->post_title.'</h5>
						            <div class="post_detail">'.$portfolio->post_excerpt.'</div>
			...
			case 'Vimeo Video':
					...
					$return_html.= '<a title="'.esc_attr($portfolio->post_title).'" href="#video_'.$portfolio_video_id.'" class="lightbox_vimeo"><img src="'.esc_url($image_url[0]).'" alt="'.esc_attr($portfolio->post_title).'"/><div id="portfolio_desc_'.esc_attr($portfolio_ID).'" class="portfolio_title">
        					<div class="table">
        						<div class="cell">
						            <h5>'.$portfolio->post_title.'</h5>
						            <div class="post_detail">'.$portfolio->post_excerpt.'</div>
			...
			case 'Self-Hosted Video':
			    ...
			    $preview_image = wp_get_attachment_image_src($image_id, 'large', true);
					...
					$return_html.= '<a title="'.esc_attr($portfolio->post_title).'" href="#video_self_'.$key.'" class="lightbox_vimeo"><img src="'.esc_url($image_url[0]).'" alt="'.esc_attr($portfolio->post_title).'"/><div id="portfolio_desc_'.esc_attr($portfolio_ID).'" class="portfolio_title">
        					<div class="table">
        						<div class="cell">
						            <h5>'.$portfolio->post_title.'</h5>
						            <div class="post_detail">'.$portfolio->post_excerpt.'</div>
